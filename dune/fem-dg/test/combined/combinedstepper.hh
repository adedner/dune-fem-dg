...
template< class ProblemCreator1,
          class ProblemCreator2 >
struct CombinedStepper
  : public AlgorithmBase< typename CombinedStepperTraits< typename ProblemCreator1::StepperType, typename ProblemCreator2::StepperType >::GridType,
                          CombinedSolverMonitor< typename ProblemCreator1::StepperType::SolverMonitorType, typename ProblemCreator2::StepperType::SolverMonitorType > >
{
  // my traits class
  typedef typename ProblemCreator1::StepperType Stepper1;
  typedef typename ProblemCreator2::StepperType Stepper2;
            ...
            SolverMonitorType& monitor )
  {
    ...
    // }
    stepper1_.step( tp, monitor );
    stepper2_.step( tp, monitor );
  }
